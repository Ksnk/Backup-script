...
//  restore-only параметры
    ...
    /**
     * Временный метод необходим на время создания всего функционала работы с БД. В дальнейшем планирую перенести получение адаптера в конструктор.
     */
    public function setAdapter(Backup_Adapter $adapter) {
        $this->adapter = $adapter;
        $this->adapter->showCreateTable('order');
    }
